...
/**
 * Display Pathology service record with Results table as a rowspan table on Test and Date column.
 *
 * @author Thompson 23/06/2020
 * @copyright Copyright (c) Smart Health Solutions Pty Ltd, 2020
 */
class PathologyService extends React.Component<EditViewFormComponentProps<EntityData>>
{
    public render()
    {
        const customFields = {
