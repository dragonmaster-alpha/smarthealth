...
/**
 * Table to allow selection of a row
 *
...
interface MockUpSelectionTableProps extends BaseContextFieldComponentProps
{
    onSelection: (selection: TableRow) => void;
    value: any;
}

@observer
class MockUpSelectionTable extends BaseContextFieldComponent<MockUpSelectionTableProps>
{
    @observable
...
export default MockUpSelectionTable;
