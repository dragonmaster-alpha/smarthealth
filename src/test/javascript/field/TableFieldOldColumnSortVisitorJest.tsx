...
{
    const sortFunction = TableFieldOldColumnSortVisitor.accept(field);
    return sortFunction(field.id, sortOrder, tableData);
};
...
describe('BooleanField', () =>
{
    ...
    const expectedValue = [
        { field: false, familyName: 'Do', age: 29 },
        { field: false, familyName: 'Do', age: 29 },
        { field: true, familyName: 'Do', age: 29 },
        { field: true, familyName: 'Do', age: 29 }
    ];
    test('true/false', () =>
    {
...
describe('MemberField', () =>
{
    ...
    test('order Members with null value', () =>
    {
        const expectedMembers: {}[] = [
            { Member: null, date: { iso: '1970-08-22' }, age: 60 },
