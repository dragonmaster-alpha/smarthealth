...
/**
 * Transfer object created from Java object au.com.smarthealth.server.rest.form.FormFieldValueSet
 * Generated by Maven. See Java class GenerateTypeScript.
 */
interface FormFieldValueSet {
    layoutCheckBoxes?: boolean;
    multiple?: boolean;
    valueSetID: string;
...
export default FormFieldValueSet;
