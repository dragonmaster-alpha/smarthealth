import FormFieldFormattedFormat from './FormFieldFormattedFormat';
...
/**
 * Transfer object created from Java object au.com.smarthealth.server.rest.form.FormFieldFormatted
 * Generated by Maven. See Java class GenerateTypeScript.
 */
interface FormFieldFormatted {
    format: FormFieldFormattedFormat;
    size: number;
...
export default FormFieldFormatted;
